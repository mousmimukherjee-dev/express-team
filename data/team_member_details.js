export const teamMembers = [
  ...
  },
  {
    id: 2,
    name: 'Signe',
    role: 'Trends & Lifestyle Editor',
    bio: 'Signe connects the dots between tech, beauty, and lifestyle. She spots trends early and focuses on products that fit seamlessly into modern living. Her passion lies in finding gadgets that feel intuitive, stylish, and ahead of their time—perfect for people who love innovation without complexity.',
    image: '/images/signe.png',
    email: 'signe@lots.com',
    linkedin: 'https://linkedin.com',
  },
  {
    id: 3,
    ...
    bio: 'Villiam lives for cutting-edge technology. From smart home upgrades to productivity gadgets and futuristic accessories, he’s always chasing the next big thing. He’s the one asking, “Does this actually make life better?” If a product earns Villiam’s approval, it’s not just cool—it’s clever.',
    image: '/images/villiam.png',
    email: 'villiam@lots.com',
    linkedin: 'https://linkedin.com',
  },
  {
    id: 4,
    name: 'Buddhi',
    role: 'Vehicle & Mobility Specialist',
